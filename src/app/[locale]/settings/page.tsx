...
export default function SettingsPage() {
  ...
  const { localVideoEnabled, localAudioEnabled, setLocalVideoEnabled, setLocalAudioEnabled, connectionStatus } = useStore((state) => ({
  ...
  return (
    <div className="flex flex-col h-full normal-bg relative">
      {/* Header */}
      <PageHeader title={t('deviceSettings')}>
        <IconButton
          onClick={handleClose}
          size="small"
          aria-label={t('close')}
